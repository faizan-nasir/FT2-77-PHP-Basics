...
<body>
  <div class="forms">
    ...
    <form action="./output.php" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="firstname" pattern="^[a-z A-Z]*$" id="fname" required />
      ...
      <textarea name="score" id="score" cols="20" rows="10" placeholder="Please enter subjects in the format English|90 separated by new lines" required></textarea>
